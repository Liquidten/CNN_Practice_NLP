...
if __name__=="__main__":
    ...
    embedding_1 = Embedding(vocab_size,300,input_length=Maxlen)
    ...
    tensorboard = TensorBoard(log_dir="logs/testCNN1")
    x = model.fit(np.array(X_train), np.array(y_label), epochs=20, batch_size = 1, validation_data = (np.array(X_dev), np.array(y_dev)),callbacks=[tensorboard])
    #model.summary()
